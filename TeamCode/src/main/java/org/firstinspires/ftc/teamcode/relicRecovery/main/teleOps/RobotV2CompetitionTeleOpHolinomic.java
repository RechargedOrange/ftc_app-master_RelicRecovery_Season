...
@TeleOp(name = RobotV2CompetitionTeleOpHolinomic.name)
public class RobotV2CompetitionTeleOpHolinomic extends LinearOpMode{

    static final public String name = "Competition TeleOp Holinomic";
    ...
    public void runOpMode() throws InterruptedException{
        ...
        while(opModeIsActive()){
            ...
            if(abs(forward) < 0.1)
                forward = 0.0;
            double strafeLeft = -gamepad1.right_stick_x;
            ...
            double frontLeft = forward + strafeLeft + turnRight;
            double frontRight = forward - strafeLeft - turnRight;
            double backRight = forward + strafeLeft - turnRight;
            double backLeft = forward - strafeLeft + turnRight;

            hardwareClass.leftFront.setPower(frontLeft);
            hardwareClass.leftBack.setPower(backLeft);
            hardwareClass.rightFront.setPower(frontRight);
            hardwareClass.rightBack.setPower(backRight);
