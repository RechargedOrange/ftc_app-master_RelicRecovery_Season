 ...
 */
@Autonomous(name = "Blue_SidePad_55PTS_CorrectColumn_Park")
//@Disabled
public class Blue_SidePad_55PTS_CorrectColumn_Park extends LinearOpMode{
    HardwareClass hardwareClass;
    MasterVuforia vuforia;
    RelicRecoveryVuMark vuMark = CENTER;
